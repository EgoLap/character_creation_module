...
def attack(char_name: str, char_class: str) -> str:
    """Рандомит нанесенный урон в зависимости от класса персонажа."""
...
def defence(char_name: str, char_class: str) -> str:
    """Возвращает блокированный урон в зависимости от класса персонажа."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Возвращает специальное умение в зависимости от класса персонажа."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Вызывает функции в зависимости от класса персонажа."""
    if char_class == 'warrior':
